...
namespace UniRPG.Core.UI.Dragging
{
    /// <summary>
        ...
        where T : class
    {
        ...
        private IDragDestination<T> GetContainer(PointerEventData eventData)
        {
            if (eventData.pointerEnter)
            {
                ...
                if (container == null){
                    Debug.LogWarning("eventData.pointerEnter.GetComponentInParent<IDragDestiantion<T>>() has returned null in Assets.Scripts.UI.Inventory.DragItem.cs");
                }
                return container;
            }
            return null;
